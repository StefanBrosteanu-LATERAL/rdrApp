...
public class KmlScanner {
     ...
     */
    void visitElement_kml(Element element) {
        kmlType = new KmlType();
     ...
     */
    void visitElement_Document(Element element) {
     ...
     */
    void visitElement_Style(Element element) {
     ...
     */
    void visitElement_IconStyle(Element element) {
        org.w3c.dom.NodeList nodes = element.getChildNodes();
        for (int i = 0; i < nodes.getLength(); i++) {
            org.w3c.dom.Node node = nodes.item(i);
            switch (node.getNodeType()) {
     ...
     */
    void visitElement_Icon(Element element) {
        org.w3c.dom.NodeList nodes = element.getChildNodes();
        for (int i = 0; i < nodes.getLength(); i++) {
            org.w3c.dom.Node node = nodes.item(i);
            switch (node.getNodeType()) {
     ...
     */
    void visitElement_href(Element element) {
        String parentNode = element.getParentNode().getNodeName();
        if(element.getChildNodes().getLength() == 0)
            return;
     ...
     */
    void visitElement_LineStyle(Element element) {
        org.w3c.dom.NodeList nodes = element.getChildNodes();
        for (int i = 0; i < nodes.getLength(); i++) {
            org.w3c.dom.Node node = nodes.item(i);
            switch (node.getNodeType()) {
     ...
     */
    void visitElement_color(Element element) {
        String parentNode = element.getParentNode().getNodeName();
     ...
     */
    void visitElement_width(Element element) {
        String parentNode = element.getParentNode().getNodeName();
        if ("LineStyle".equals(parentNode)) {
     ...
     */
    void visitElement_Placemark(Element element) {
     ...
     */
    void visitElement_styleUrl(Element element) {
        String parentNode = element.getParentNode().getNodeName();
        if ("Placemark".equals(parentNode)) {
     ...
     */
    void visitElement_Point(Element element) {
        org.w3c.dom.NodeList nodes = element.getChildNodes();
        for (int i = 0; i < nodes.getLength(); i++) {
            org.w3c.dom.Node node = nodes.item(i);
            switch (node.getNodeType()) {
     ...
     */
    void visitElement_coordinates(Element element) {
        String parentNode = element.getParentNode().getNodeName();
     ...
     */
    void visitElement_ExtendedData(Element element) {
        org.w3c.dom.NodeList nodes = element.getChildNodes();
        for (int i = 0; i < nodes.getLength(); i++) {
            org.w3c.dom.Node node = nodes.item(i);
            switch (node.getNodeType()) {
     ...
     */
    void visitElement_Data(Element element) {
        org.w3c.dom.NamedNodeMap attrs = element.getAttributes();
        for (int i = 0; i < attrs.getLength(); i++) {
            org.w3c.dom.Attr attr = (org.w3c.dom.Attr) attrs.item(i);
     ...
     */
    void visitElement_value(Element element) {
     ...
     */
    void visitElement_LineString(Element element) {
        org.w3c.dom.NodeList nodes = element.getChildNodes();
        for (int i = 0; i < nodes.getLength(); i++) {
            org.w3c.dom.Node node = nodes.item(i);
            switch (node.getNodeType()) {
     ...
     */
    void visitElement_tessellate(Element element) {
        String parentNode = element.getParentNode().getNodeName();
        if ("LineString".equals(parentNode)) {
